...
const dialogue = {
	...
	Hector: [
		...
		["Hector", "Anyway, you're right that there's no particularly practical purpose."],
	...
	Serapio: [
		...
		["Serapio", "Oh? Are you so easily stumped that you need jump to the 'it's not a riddle' strategy?"],
		...
		["Claudia", "Since it's run by the community, content is dictated by interest rather than financial incentive."],
	...
	Nero: [
		...
		["Claudia", "Are you under the impression that I'm under a moral dilemna right now?"],
		["Nero", "Well, yeah."],
